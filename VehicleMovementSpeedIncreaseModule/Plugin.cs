...
namespace AshFox.Subnautica
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        public const string PluginName = "VehicleMovementSpeedIncreaseModule";
        ...
        private void Awake()
        {
            ...
            LocalizationManager.Initialize();
                    ...
                    // 速度乗数を初期化
                    VehicleSpeedPatch.InitializeSpeedMultipliers();

                    // Harmonyパッチを適用
                    new Harmony(PluginGuid).PatchAll();

            Log.LogInfo("VehicleMovementSpeedIncreaseModule loaded successfully!");
        }
    }
}
